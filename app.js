/* LNAT Exam Simulator — Application Logic */

const ACCESS_CODE  = "LNAT9000";
const EXAM_SECONDS = 5688;
const PASSING_PCT  = 72;
const STORAGE_KEY  = "lnat_exam_state_v1";
...
function renderQuestion() {
  ...
  if (q.passage_text) {
    document.getElementById("q-passage-title").textContent = q.passage_title || "";
    document.getElementById("q-passage-text").textContent  = q.passage_text;
...
function renderReview() {
  ...
  document.getElementById("question-text").textContent = q.question;
  const revPassageWrap = document.getElementById("q-passage-wrap");
  if (q.passage_text) {
    document.getElementById("q-passage-title").textContent = q.passage_title || "";
    document.getElementById("q-passage-text").textContent  = q.passage_text;
    revPassageWrap.style.display = "block";
  } else {
    revPassageWrap.style.display = "none";
  }
